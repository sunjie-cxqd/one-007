...
特点：很好的实现了结构与表现相分离，降低了服务器成本，控制了页面布局，提高了页面加载速度

作用： 规定html元素如何在浏览器中呈现
...
注： a) 声明要放在花括号中，建议每条声明占一行，每条声明结束要加分号
...
语法： 首先创建一个后缀名为.css的文件，然后在html页面使用link标签引入，即：

<link rel="stylesheet" type="text/css" href="css文件路径"/>

注：  rel的作用：表明引入文件与当前文件的关系
...
注：当css属性值中出现!important关键词时，它的优先级最高

即：  !important>内联>内部>外部
