...
eg:   <h1 id="qfEdu">千锋教育</h1>

         #qfEdu{color:red;}

注：a) id名要语义化命名，不能是数字，汉字，关键词，敏感词，也不能以数字开头，要语义化命名

           常见命名方法：驼峰命名法  例如  id="qfEduTxt"   
                                   下划线或中划线连接命名法      例如   id="qf_edu_txt"   或  id="qf-edu-txt"
...
eg:   <h1 class="qfEdu">西安千锋教育</h1>    <h1 class="qfEdu">北京千锋教育</h1>
...
注：使用后代选择器时，选择符1和选择符2必须是包含与被包含的关系

5.群组选择器

语法： 选择符1,选择符2,选择符3,选择符4{属性:属性值;}

eg:  ul,ol{list-style:none;}
...
注：为了简化代码，可以把伪类选择符中相同的声明提出来放在a选择符中，即
